...
fprintf('\nSinal analisado: o3.wav\n');
fprintf('\nTipo: Discreto\n');
fprintf('\nRecuperando dados do sinal\n');

%%Recuperacao de dados da amostra
[gk, fs] = audioread ('audio/o3.wav');         % transforma um arquivo .wav em um vetor g(k)
...
title('Sinal o3.wav amostrado')        % titulo
grid
saveas(fig1,'o3.png') 
...
title('Espectro de amplitude de o3.wav')        % titulo
grid
saveas(fig2,'freq_o3.png')            %Salva os graficos como png
